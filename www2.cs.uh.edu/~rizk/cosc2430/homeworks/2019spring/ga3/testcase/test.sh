...
./lss "input=input1.txt;output=output1.txt" 1>1.stdcout 2>1.stderr
...
# For test case 2
./lss "input=input2.txt;output=output2.txt" 1>1.stdcout 2>1.stderr
...
# For test case 3
./lss "input=input3.txt;output=output3.txt" 1>1.stdcout 2>1.stderr
